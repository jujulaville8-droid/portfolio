    ...
    <section id="contact" className="relative py-32 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="px-8 py-4 rounded-full text-base font-semibold text-stone-400 border border-stone-700 hover:border-amber-700/50 hover:text-amber-200 transition-all duration-300 inline-flex items-center gap-3"
            >
        ...
        <motion.div
          ...
          className="mt-20 h-px bg-gradient-to-r from-transparent via-amber-700/40 to-transparent"
        />
      </div>
    </section>
  );
