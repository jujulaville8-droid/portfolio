        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="px-8 py-4 rounded-sm text-sm font-semibold text-stone-500 border-2 border-stone-300 hover:border-amber-800/40 hover:text-stone-700 transition-all duration-300 tracking-wide uppercase inline-flex items-center gap-3"
            >
